...
public partial class App : Application
{
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // Заменяем AddDbContext на AddDbContextFactory.
        // Фабрика регистрируется как Singleton и позволяет создавать
        // короткоживущие экземпляры DbContext по требованию.
        // Это решает проблему Captive Dependency - контекст больше не захватывается
        // долгоживущими ViewModel, а создаётся и уничтожается в блоке using.
